...
const scenarios = {
        ...
        choices: [
            {
                ...
                isCultureFit: true,
                nextMessage: { sender: "정우", avatar: "PM", content: "수강생 체감 실전성을 빠르게 높일 수 있는 선택인 것 같아요", isUser: false }
            },
            {
                id: "1b",
                ...
                isCultureFit: false,
                nextMessage: { sender: "유진", avatar: "DEG", content: "흐름이 좋은데요? 그룹 피드백 구조만 잘 잡으면 문제 없을 것 같아요.", isUser: false }
            },
            {
                id: "1c",
                ...
                isCultureFit: false,
                nextMessage: { sender: "지원", avatar: "COP", content: "사후 지원을 보강한다는 접근이네요. 제작 범위와 품질관리 중요하겠어요.", isUser: false }
            }
        ]
    },
        ...
        choices: [
            {
                ...
                isCultureFit: true,
                nextMessage: { sender: "은혜", avatar: "COP", content: "핵심 가치를 지키면서 할 수 있는 현실적인 절충안이네요.", isUser: false }
            },
            {
                id: "2b",
                ...
                isCultureFit: false,
                nextMessage: { sender: "효주", avatar: "COP", content: "운영 효율은 올라가겠지만 1:1 품질 보완이 관건이겠어요.", isUser: false }
            },
            {
                id: "2c",
                ...
                points: { customer: 4, partnership: 4, worklife: 5, innovation: 3, efficiency: 4 },
                isCultureFit: false,
                nextMessage: { sender: "정우", avatar: "PM", content: "대체 가능한 자원 동원, 좋습니다. 품질/책임소재 명확히 하도록 하죠.", isUser: false }
            }
        ]
    },
        ...
        choices: [
            {
                ...
                isCultureFit: false,
                nextMessage: { sender: "효주", avatar: "COP", content: "도전적인데요. 전환 부담을 감수해야 합니다.", isUser: false }
            },
            {
                id: "3b",
                ...
                isCultureFit: true,
                nextMessage: { sender: "정우", avatar: "PM", content: "리스크 관리와 혁신 균형이 좋네요. 파일럿 설계부터 진행하면 좋을 것 같네요.", isUser: false }
            },
            {
                id: "3c",
                ...
                isCultureFit: false,
                nextMessage: { sender: "지원", avatar: "COP", content: "충실한 준비가 되겠네요. 기회를 놓치지 않게 체크도 까먹지 않아야겠어요요.", isUser: false }
            }
        ]
    },
        ...
        choices: [
            {
                ...
                isCultureFit: false,
                nextMessage: { sender: "은혜", avatar: "COP", content: "업무와 팀 피로도 사이의 균형을 조정하는 것이 핵심이겠네요.", isUser: false }
            },
            {
                id: "4b",
                ...
                isCultureFit: true,
                nextMessage: { sender: "정우", avatar: "PM", content: "균형 및 전략과 개인, 팀 단위 역할/성과 지표를 명확히 할 필요가 있겠어요.", isUser: false }
            },
            {
                id: "4c",
                ...
                points: { customer: 4, partnership: 4, worklife: 5, innovation: 4, efficiency: 3 },
                isCultureFit: false,
                nextMessage: { sender: "지원", avatar: "COP", content: "기회비용을 정기적으로 점검하고, 핵심 사업에 집중하는 방법이네요", isUser: false }
            }
        ]
    },
    ...
    scenario5: {
        ...
        messages: [
            { id: 1, sender: "효주", avatar: "COP", content: "회의가 너무 길어 다른 업무에 지장이 있어요.", isUser: false, delay: 800 },
            { id: 2, sender: "유진", avatar: "DEG", content: "비동기 협업 툴을 적극 쓰면 좋겠습니다.", isUser: false, delay: 800 },
            { id: 3, sender: "정우", avatar: "PM", content: "다음 분기부터 회의 방식을 바꿔봅시다.", isUser: false, delay: 800 }
        ],
        choices: [
            {
                id: "5a",
                ...
                isCultureFit: true,
                nextMessage: { sender: "정우", avatar: "PM", content: "명확하고 실천 가능한 가이드네요. 바로 시범 적용해보아도 좋을 것 같습니다.", isUser: false }
            },
            {
                id: "5b",
                ...
                isCultureFit: false,
                nextMessage: { sender: "효주", avatar: "COP", content: "집중도가 오를 수 있을 것 같아요. 회의에 관한 규칙 합의가 필요하겠어요.", isUser: false }
            },
            {
                id: "5c",
